...
## Project Structure
    ...
    ├── model_methods_test_102293  # Django project configurations
...
1. Clone this repo and `cd model_methods_test_102293`
...
2. Clone this repo and `cd model_methods_test_102293`
